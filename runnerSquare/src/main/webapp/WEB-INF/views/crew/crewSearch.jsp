...
<div class="body">
	<h1>크루 검색</h1>
	<form id="search-form">
		<select id="citySelect" onchange="changeState()">
		    <option value="">시/도</option>
		</select>
		<select id="districtSelect">
		    <option value="">시/군/구</option>
		</select>
		<input type="text" id="crewName" placeholder="크루명"/>
		<input type="submit" value="검색"/>
	</form>
	<ul>
	<c:forEach begin="1" end="10">
		<li class="crewList">
			<img class="crewImg" src="${pageContext.request.contextPath}/img/running.jpg"/>
			<div>
				<h2>크루명</h2>
				<div>크루소개<br/>크루소개<br/>크루소개<br/>크루소개</div>
			</div>
		</li>
	</c:forEach>
	</ul>
